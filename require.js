...
var require = (function () {
            ...
            if (require.file.test(path)) {
                if (state === PATH_TO_PACKAGE) {
                    try {
                        ...
                        throw 'Can`t parse .json file: "' + path + '". Call stack:';
                    }
    ...
    Module.prototype.compile = function () {
        try {
            ...
            if (error !== CANT_FIND_ERR_NAME) {
                error = error + ' "' + this.path + '"';
            }
    ...
    function Require(namespace) {
        ...
        if (typeof namespace !== 'string' || namespace === '') {
            throw 'First argument must be non-empty string. Call stack:';
        }
        ...
        if (namespace.indexOf('docroot://') === 0) {
            try {
                ...
                if (error === CANT_FIND_ERR_NAME) {
                    error = 'Can`t find module "' + namespace + '", from paths: "' + Require.path.join(', ') + '", call stack:';
                }
            ...
            if (module) {
                ...
                throw 'Can`t find module "' + namespace + '", from paths: "' + Require.path.join(', ') + '", call stack:';
            }
        }
